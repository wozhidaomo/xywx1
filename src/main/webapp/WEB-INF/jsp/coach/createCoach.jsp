...
<body>
<form action="saveCreate" class="uk-form" name="pageForm" method="post" id="coachForm" enctype="multipart/form-data">
...
<div class="uk-grid">
    ...
    <input class="uk-form-width-large "  type="text" placeholder="姓名" name="name" id="name" value="" >
    </div>
</div>
</dt>
...
<div class="uk-grid">
    ...
    <img class="uk-thumbnail" src="" alt="头像" >
...
<div class="uk-grid">
    ...
    <div class="uk-width-1-2">
    <textarea class="uk-form-width-large " cols="30" rows="10" placeholder="教练简介" name="describe" >${coach.describe }</textarea>
    </div>
</div>
</dt>
...
<div class="uk-grid">
    ...
    <div class="uk-width-1-2">
    <input class=" uk-form-width-large " type="text" placeholder="教练详情" name="detaillink" value="${coach.detaillink }" type="url" >
    </div>
</div>
