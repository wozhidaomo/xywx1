...
<body>
<form class="uk-form uk-form-horizontal" action="saveEdit" id="questionForm">
        <legend>编辑题目</legend>
    ...
    <div class="uk-form-row">
        ...
        <input class="uk-form-width-medium" type="text" placeholder="题目标题" id="title"
				name="question.name" value="${question.name }">
        </div>
    </div>
    ...
    <div class="uk-form-row">
        ...
        <div class="uk-form-controls">
        <input type="hidden" name="topicoptions[0].id" value="${topicOptions[0].id }">
        <input class="uk-margin-small-top" type="text" placeholder="最低分" id="min"
				name="topicoptions[0].optionvalue" value="${topicOptions[0].optionvalue }">&nbsp;-
				<input class="uk-margin-small-top" type="text" placeholder="表征意义" 
				name="topicoptions[0].showmean" value="${topicOptions[0].showmean }">
        </div>
    </div>
    </div>
    ...
    <div class="uk-form-row">
        ...
        <div class="uk-form-controls">
        <input type="hidden" name="topicoptions[1].id" value="${topicOptions[1].id}" />
        <input class="uk-margin-small-top" type="text" placeholder="最高分" id="max"
				name="topicoptions[1].optionvalue" value="${topicOptions[1].optionvalue }">&nbsp;-
				<input class="uk-margin-small-top" type="text" placeholder="表征意义" 
				name="topicoptions[1].showmean" value="${topicOptions[1].showmean }">
        </div>
    </div>
